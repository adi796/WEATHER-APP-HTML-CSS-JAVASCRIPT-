...
const apiKey = 'ecc810802341c3dab75e7f897a2d1fa5'
    ...
    data.then((response) => {
        ...
        let html = `
                ...
                <div class="weather-details">
                    <div class="weather-logo"><img src="https://openweathermap.org/img/wn/${response.weather[0].icon}@2x.png" alt="icon"></div>
